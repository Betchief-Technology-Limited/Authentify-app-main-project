...
function totpVerify(token, secret, opts={}){
    const step = opts.step || DEFAULT_STEP;
    const window = typeof opts.window === 'number' ? opts.window : 1; //allow ±1 by default 
    const digits = opts.digits || DEFAULT_DIGITS;
...
export { DEFAULT_ALGORITHM, DEFAULT_DIGITS, DEFAULT_STEP, MIN_SECRET_BYTES, base32ToBuffer, bufferToBase32, generateOtpauthURI, generateSecret, hotp, hotpVerify, totp, totpVerify };
